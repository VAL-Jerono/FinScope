...
def create_regional_data():
    # Champions data from your document
    champions_data = [
        # High Income
        {'region': 'High Income', 'group': 'In Labor Force', 'rate': 0.930, 'icon': '💼', 'type': 'Champion'},
        {'region': 'High Income', 'group': 'Rich 60%', 'rate': 0.903, 'icon': '💰', 'type': 'Champion'},
        {'region': 'High Income', 'group': 'Higher Education', 'rate': 0.897, 'icon': '🎓', 'type': 'Champion'},
        {'region': 'High Income', 'group': 'Urban', 'rate': 0.891, 'icon': '🏙️', 'type': 'Champion'},
        {'region': 'High Income', 'group': 'Men', 'rate': 0.888, 'icon': '👨', 'type': 'Champion'},
        
        # Europe & Central Asia
        {'region': 'Europe Central Asia', 'group': 'Urban', 'rate': 0.769, 'icon': '🏙️', 'type': 'Champion'},
        {'region': 'Europe Central Asia', 'group': 'Rural', 'rate': 0.707, 'icon': '🌾', 'type': 'Champion'},
        {'region': 'Europe Central Asia', 'group': 'In Labor Force', 'rate': 0.704, 'icon': '💼', 'type': 'Champion'},
        {'region': 'Europe Central Asia', 'group': 'Higher Education', 'rate': 0.638, 'icon': '🎓', 'type': 'Champion'},
        {'region': 'Europe Central Asia', 'group': 'Rich 60%', 'rate': 0.626, 'icon': '💰', 'type': 'Champion'},
        
        # East Asia & Pacific
        {'region': 'East Asia Pacific', 'group': 'Urban', 'rate': 0.766, 'icon': '🏙️', 'type': 'Champion'},
        {'region': 'East Asia Pacific', 'group': 'Higher Education', 'rate': 0.677, 'icon': '🎓', 'type': 'Champion'},
        {'region': 'East Asia Pacific', 'group': 'Rural', 'rate': 0.670, 'icon': '🌾', 'type': 'Champion'},
        {'region': 'East Asia Pacific', 'group': 'Rich 60%', 'rate': 0.637, 'icon': '💰', 'type': 'Champion'},
        {'region': 'East Asia Pacific', 'group': 'In Labor Force', 'rate': 0.597, 'icon': '💼', 'type': 'Champion'},
        
        # South Asia
        {'region': 'South Asia', 'group': 'Higher Education', 'rate': 0.597, 'icon': '🎓', 'type': 'Champion'},
        {'region': 'South Asia', 'group': 'Rural', 'rate': 0.596, 'icon': '🌾', 'type': 'Champion'},
        {'region': 'South Asia', 'group': 'In Labor Force', 'rate': 0.560, 'icon': '💼', 'type': 'Champion'},
        
        # Latin America & Caribbean
        {'region': 'Latin America', 'group': 'Urban', 'rate': 0.642, 'icon': '🏙️', 'type': 'Champion'},
        {'region': 'Latin America', 'group': 'In Labor Force', 'rate': 0.569, 'icon': '💼', 'type': 'Champion'},
        {'region': 'Latin America', 'group': 'Higher Education', 'rate': 0.564, 'icon': '🎓', 'type': 'Champion'},
        
        # Sub-Saharan Africa
        {'region': 'Sub-Saharan Africa', 'group': 'Urban', 'rate': 0.645, 'icon': '🏙️', 'type': 'Champion'},
        {'region': 'Sub-Saharan Africa', 'group': 'Higher Education', 'rate': 0.570, 'icon': '🎓', 'type': 'Champion'},
        {'region': 'Sub-Saharan Africa', 'group': 'Rural', 'rate': 0.516, 'icon': '🌾', 'type': 'Champion'},
        
        # MENA
        {'region': 'MENA', 'group': 'In Labor Force', 'rate': 0.540, 'icon': '💼', 'type': 'Champion'},
        {'region': 'MENA', 'group': 'Urban', 'rate': 0.491, 'icon': '🏙️', 'type': 'Champion'},
        {'region': 'MENA', 'group': 'Men', 'rate': 0.476, 'icon': '👨', 'type': 'Champion'},
    ]
    
    # Priority groups data from your document
    priority_data = [
        # High Income (even their "worst" are better than others' best)
        {'region': 'High Income', 'group': 'Primary Education', 'rate': 0.769, 'icon': '📚', 'type': 'Priority'},
        {'region': 'High Income', 'group': 'Age 15-24', 'rate': 0.781, 'icon': '👶', 'type': 'Priority'},
        {'region': 'High Income', 'group': 'Out of Labor', 'rate': 0.804, 'icon': '❌', 'type': 'Priority'},
        {'region': 'High Income', 'group': 'Poor 40%', 'rate': 0.834, 'icon': '💸', 'type': 'Priority'},
        {'region': 'High Income', 'group': 'Women', 'rate': 0.855, 'icon': '👩', 'type': 'Priority'},
        
        # Europe & Central Asia
        {'region': 'Europe Central Asia', 'group': 'Primary Education', 'rate': 0.390, 'icon': '📚', 'type': 'Priority'},
        {'region': 'Europe Central Asia', 'group': 'Age 15-24', 'rate': 0.428, 'icon': '👶', 'type': 'Priority'},
        {'region': 'Europe Central Asia', 'group': 'Out of Labor', 'rate': 0.448, 'icon': '❌', 'type': 'Priority'},
        {'region': 'Europe Central Asia', 'group': 'Poor 40%', 'rate': 0.484, 'icon': '💸', 'type': 'Priority'},
        {'region': 'Europe Central Asia', 'group': 'Women', 'rate': 0.540, 'icon': '👩', 'type': 'Priority'},
        
        # East Asia & Pacific
        {'region': 'East Asia Pacific', 'group': 'Primary Education', 'rate': 0.457, 'icon': '📚', 'type': 'Priority'},
        {'region': 'East Asia Pacific', 'group': 'Poor 40%', 'rate': 0.484, 'icon': '💸', 'type': 'Priority'},
        {'region': 'East Asia Pacific', 'group': 'Out of Labor', 'rate': 0.489, 'icon': '❌', 'type': 'Priority'},
        {'region': 'East Asia Pacific', 'group': 'Age 15-24', 'rate': 0.543, 'icon': '👶', 'type': 'Priority'},
        {'region': 'East Asia Pacific', 'group': 'Women', 'rate': 0.576, 'icon': '👩', 'type': 'Priority'},
        
        # South Asia
        {'region': 'South Asia', 'group': 'Poor 40%', 'rate': 0.401, 'icon': '💸', 'type': 'Priority'},
        {'region': 'South Asia', 'group': 'Primary Education', 'rate': 0.419, 'icon': '📚', 'type': 'Priority'},
        {'region': 'South Asia', 'group': 'Age 15-24', 'rate': 0.431, 'icon': '👶', 'type': 'Priority'},
        {'region': 'South Asia', 'group': 'Out of Labor', 'rate': 0.432, 'icon': '❌', 'type': 'Priority'},
        {'region': 'South Asia', 'group': 'Women', 'rate': 0.435, 'icon': '👩', 'type': 'Priority'},
        
        # Latin America & Caribbean
        {'region': 'Latin America', 'group': 'Primary Education', 'rate': 0.368, 'icon': '📚', 'type': 'Priority'},
        {'region': 'Latin America', 'group': 'Poor 40%', 'rate': 0.381, 'icon': '💸', 'type': 'Priority'},
        {'region': 'Latin America', 'group': 'Out of Labor', 'rate': 0.386, 'icon': '❌', 'type': 'Priority'},
        {'region': 'Latin America', 'group': 'Age 15-24', 'rate': 0.403, 'icon': '👶', 'type': 'Priority'},
        {'region': 'Latin America', 'group': 'Women', 'rate': 0.454, 'icon': '👩', 'type': 'Priority'},
        
        # Sub-Saharan Africa
        {'region': 'Sub-Saharan Africa', 'group': 'Out of Labor', 'rate': 0.330, 'icon': '❌', 'type': 'Priority'},
        {'region': 'Sub-Saharan Africa', 'group': 'Poor 40%', 'rate': 0.333, 'icon': '💸', 'type': 'Priority'},
        {'region': 'Sub-Saharan Africa', 'group': 'Primary Education', 'rate': 0.337, 'icon': '📚', 'type': 'Priority'},
        {'region': 'Sub-Saharan Africa', 'group': 'Age 15-24', 'rate': 0.361, 'icon': '👶', 'type': 'Priority'},
        {'region': 'Sub-Saharan Africa', 'group': 'Women', 'rate': 0.383, 'icon': '👩', 'type': 'Priority'},
        
        # MENA (Worst performers)
        {'region': 'MENA', 'group': 'Age 15-24', 'rate': 0.267, 'icon': '👶', 'type': 'Priority'},
        {'region': 'MENA', 'group': 'Out of Labor', 'rate': 0.295, 'icon': '❌', 'type': 'Priority'},
        {'region': 'MENA', 'group': 'Women', 'rate': 0.300, 'icon': '👩', 'type': 'Priority'},
        {'region': 'MENA', 'group': 'Poor 40%', 'rate': 0.304, 'icon': '💸', 'type': 'Priority'},
        {'region': 'MENA', 'group': 'Primary Education', 'rate': 0.330, 'icon': '📚', 'type': 'Priority'},
    ]
    
    return pd.DataFrame(champions_data + priority_data)
...
def create_regional_comparison_plot():
    ...
    fig = px.bar(
        ...
        color='type',
        pattern_shape='group',
        title="<b>Financial Inclusion: Regional Champions vs Priority Groups</b>",
        color_discrete_map={
            'Champion': '#27AE60',  # Green for champions
            'Priority': '#E74C3C'   # Red for priority groups
        },
        height=700,
        hover_data={
            'rate': ':.1%',
    ...
    fig.update_traces(
        hovertemplate='<b>%{customdata[2]} %{customdata[0]}</b><br>' +
                      'Region: %{x}<br>' +
                      'Rate: %{y:.1%}<br>' +
                      'Type: %{customdata[1]}<br>' +
                      '<extra></extra>',
        customdata=df[['group', 'type', 'icon']].values
    )
...
# Alternative: Focus on extreme performers
def create_extreme_comparison():
    df = create_regional_data()
    
    # Get top champions and worst priority groups
    top_champions = df[df['type'] == 'Champion'].nlargest(8, 'rate')
    worst_priorities = df[df['type'] == 'Priority'].nsmallest(8, 'rate')
    
    extreme_df = pd.concat([top_champions, worst_priorities])
    
    fig = go.Figure()
    
    # Add champions
    champions = extreme_df[extreme_df['type'] == 'Champion']
    fig.add_trace(go.Bar(
        name='🏆 Champions',
        x=[f"{row['icon']} {row['group']}<br>({row['region']})" for _, row in champions.iterrows()],
        y=champions['rate'],
        marker_color='#27AE60',
        text=[f"{rate:.0%}" for rate in champions['rate']],
        textposition='outside',
        hovertemplate='<b>%{x}</b><br>Rate: %{y:.1%}<extra></extra>'
    ))
    
    # Add priorities
    priorities = extreme_df[extreme_df['type'] == 'Priority']
    fig.add_trace(go.Bar(
        name='🎯 Priority Groups',
        x=[f"{row['icon']} {row['group']}<br>({row['region']})" for _, row in priorities.iterrows()],
        y=priorities['rate'],
        marker_color='#E74C3C',
        text=[f"{rate:.0%}" for rate in priorities['rate']],
        textposition='outside',
        hovertemplate='<b>%{x}</b><br>Rate: %{y:.1%}<extra></extra>'
    ))
    ...
    fig.update_layout(
        title={
            'text': "<b>Extreme Performers: Top Champions vs Worst Priority Groups</b>",
            'x': 0.5,
            'xanchor': 'center'
        },
        xaxis_title="Demographic Groups by Region",
        yaxis_title="Financial Inclusion Rate",
        yaxis=dict(tickformat='.0%'),
        height=600,
        plot_bgcolor='rgba(0,0,0,0)',
...
view_option = st.selectbox(
    ...
    ["Complete Regional Overview", "Extreme Performers Only", "Regional Summary Stats"],
    index=0
)

if view_option == "Complete Regional Overview":
    fig = create_regional_comparison_plot()
    st.plotly_chart(fig, use_container_width=True)
    
elif view_option == "Extreme Performers Only":
    fig = create_extreme_comparison()
    st.plotly_chart(fig, use_container_width=True)
    
else:  # Regional Summary Stats
    df = create_regional_data()
    
    # Calculate summary statistics by region
    summary_stats = df.groupby(['region', 'type'])['rate'].agg(['mean', 'min', 'max', 'count']).round(3)
    summary_stats.columns = ['Average Rate', 'Min Rate', 'Max Rate', 'Count']
    
    st.markdown("### 📊 Regional Summary Statistics")
    st.dataframe(summary_stats, use_container_width=True)
    
    # Create gap analysis
    champions_avg = df[df['type'] == 'Champion'].groupby('region')['rate'].mean()
    priority_avg = df[df['type'] == 'Priority'].groupby('region')['rate'].mean()
    
    gap_df = pd.DataFrame({
        'Region': champions_avg.index,
        'Champions Average': champions_avg.values,
        'Priority Average': priority_avg.values,
        'Gap': champions_avg.values - priority_avg.values
    }).round(3)
    
    st.markdown("### 📈 Performance Gaps by Region")
    ...
    gap_fig = px.bar(
        ...
        title="<b>Performance Gap: Champions vs Priority Groups</b>",
        text='Gap'
    )
    ...
    gap_fig.update_layout(
        yaxis=dict(tickformat='.0%', title='Inclusion Rate Gap'),
        xaxis=dict(tickangle=45),
        height=400
    )
...
with st.expander("🔍 Data Insights"):
    ...
    **Key Findings from the Data:**
    ...
    🏆 **Champions:**
    - **High Income dominates**: 88-93% inclusion across all demographics
    - **Urban advantage**: Urban populations lead in every region (49-77%)
    - **Education premium**: Higher education consistently drives inclusion
    
    🎯 **Priority Groups:**
    - **MENA crisis**: Lowest rates globally (27-33% for key demographics)
    - **Youth exclusion**: 15-24 age group struggles across all regions
    - **Gender gaps**: Women underperform men in most regions
    
    📊 **Regional Patterns:**
    - **Biggest gap**: High Income (93%) vs MENA Youth (27%) = 66 percentage points
    - **Consistent barriers**: Primary education, poverty, unemployment
    - **Geographic clustering**: Similar patterns within regions
    """)
